...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        Assert.assertTrue(airport.getTransportMilitaryPlanes().stream().allMatch(planes
                -> planes.getType() == MilitaryType.TRANSPORT));
    }
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        Assert.assertEquals(planesSortedByMaxLoadCapacity.toArray(), planes.toArray());
    }

    @Test
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        Airport airport = new Airport(planes);
        Assert.assertTrue(airport.getBomberMilitaryPlanes().stream().anyMatch(planes
                -> planes.getType() == MilitaryType.BOMBER));
    }

    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        Airport airport = new Airport(planes);
        Assert.assertFalse(airport.getExperimentalPlanes().stream().anyMatch(planes
                -> planes.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED));
    }
}